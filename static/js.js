...
function calculatexy(radius,originalTheta,newTheta){
	xValue = (((2*radius^2)-4*radius*Math.cos(newTheta-originalTheta))^(1/2))*Math.cos(originalTheta-(newTheta-originalTheta)/2);
	yValue = (((2*radius^2)-4*radius*Math.cos(newTheta-originalTheta))^(1/2))*Math.sin(originalTheta-(newTheta-originalTheta)/2);
