...
class Robot(object):
    ...
    def __init__(self, port='/dev/tty.usbserial-DA01NOQ6', baud=115200):
        '''
    ...
    def getSelectedSensorData(self):
        ...
        return self.robot.sensor_state['distance'],\
               ...
               self.robot.sensor_state['left encoder counts'],\
               self.robot.sensor_state['right encoder counts'],\
